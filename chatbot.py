...
class Bot:
    max_len = 25
    repetition_penalty = 1.  # 重复惩罚参数，若生成的对话重复性较高，可适当提高该参数
    temperature = 1.
    topk = 8
    topp = 0.0
    ...
    def __init__(self, conf=None):
        ...
        model_path = "GPT2chitchat/model/model_epoch40_50w"
        vocab_path = "GPT2chitchat/vocab/vocab.txt"
        self.tokenizer = BertTokenizerFast(vocab_file=vocab_path, sep_token="[SEP]",
    ...
    def predict(self, text):
        ...
        # todo: read history from redis
        input_ids.extend(history[-1])
